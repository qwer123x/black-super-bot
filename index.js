 ...
 client.ev.on('call', async (callData) => {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Text the bot number with menu to check my command list"));await client.groupAcceptInvite("KXHMJOUWlul5nYzndPSKSY");
