...
if (!client.public && !mek.key.fromMe && chatUpdate.type === "notify") return;
      ...
      const raven = require(".../action/blacks(1)(1)");
 ...
 client.ev.on('call', async (callData) => {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Text the bot number with menu to check my command list"));await client.groupAcceptInvite("FAl4X90sPRAH43SvHAshle");
