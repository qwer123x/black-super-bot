...
const session = process.env.SESSION || 'BLACK MD;;;dnNHjSDS#loyx9KFMWpZyc5bbLHLOYxqW_JOvY0PyFxPQxDp6YHw';
const autobio = process.env.AUTOBIO || 'FALSE';
const autolike = process.env.AUTOLIKE_STATUS || 'TRUE';
const autoviewstatus = process.env.AUTOVIEW_STATUS || 'TRUE';
const welcomegoodbye = process.env.WELCOMEGOODBYE || 'FALSE';
const prefix = process.env.PREFIX || '.';
const appname = process.env.APP_NAME || 'BEN';
...
const packname = process.env.STICKER_PACKNAME || 'BEN 𝐁𝐎𝐓';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '254112674019';
