...
//========================================================================================================================// 
async function mp3d () {	
let { key } = await client.sendMessage(m.chat, {audio: fs.readFileSync('./Media/men2.mp3'), mimetype:'audio/mp4', ptt: true}, {quoted: m })
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY 𝐁𝐋𝐀𝐂𝐊𝐂𝐒-𝐌𝐃`
    });
  } catch (_0x180d034) {
    m.reply(_0x180d034);
  }
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓-𝐌𝐃`
    });
  } catch (_0x80d03) {
    m.reply(_0x80d03);
  }
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY 𝐁𝐋𝐀𝐂𝐊𝐒-𝐌𝐃`
    });
  } catch (_0x180d0) {
    m.reply(_0x180d0);
  }
...
//========================================================================================================================//		      
 ...
 m.reply("*Wait a moment...*");
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐒𝐍𝐓-𝐌𝐃`
    }, {
      quoted: m
    });
  } catch (_0x564fe1) {
...
case 'save': {
  ...
  // Check if user quoted a message and it's a status
  ...
  try {
    ...
    if (quotedMessage.imageMessage) {
      ...
      return m.reply("❌ Only images and videos can be saved");
    }

    // Confirm in original chat
    await m.reply("✅ Saved to your DM 𝑩𝒍𝒂𝒄𝒌𝒊𝒆-𝑴𝑫");

  } catch (error) {
    console.error("Save error:", error);
    await m.reply("❌ Failed to save. Please try again later 𝑩𝒍𝒂𝒄𝒌𝒊𝒆-𝑴𝑫");
  }
}
break;		      
//========================================================================================================================//		      
...
const cap = "𝗘𝗱𝗶𝘁𝗲𝗱 𝗯𝘆 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐌𝐃";
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/s5nuh3.jpg' }, caption:`𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐌𝐃\n\n𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒\n\n𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}\n\n𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂\n\n𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝐁𝐋𝐀𝐂𝐊𝐈𝐄\n\n𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: 𝐁𝐀𝐂𝐊𝐈𝐄`}); 
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝐁𝐋𝐀𝐂𝐊𝐒 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐌𝐃`,gifPlayback : false },{quoted : m}) 
...
if (!text) {
    ...
    try {
        ...
        await client.sendMessage(
            ...
            {
                video: { url: fbvid },
                caption: "𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐌𝐃",
                gifPlayback: false,
            },
            { quoted: m }
        );
...
` Hello👋 *${pushname}*,𝒀𝑶𝑼 𝑪𝑨𝑵 𝑫𝑬𝑷𝑳𝑶𝒀 𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐁𝐎𝐓 𝑼𝑺𝑰𝑵𝑮 𝑻𝑯𝑬 𝑮𝑰𝑻𝑯𝑼𝑩 𝑳𝑰𝑵𝑲 𝑩𝑬𝑳𝑶𝑾 𓅂\n\n🅵🅾🆁🅺 🅰🅽🅳 🅶🅸🆅🅴 🆄🆂 🅰 🆂🆃🅰🆁✨.\n\n ╭══──────              ─◇─             ──────══╮
...
//========================================================================================================================//		      
	case 'runtime':
		let raven = `𝐁𝐋𝐀𝐂𝐊𝐌𝐀𝐂𝐇𝐀𝐍𝐓 𝐌𝐃 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: raven,
                    contextInfo: {
                        externalAdReply: {
