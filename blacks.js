...
client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/0ykpd2.jpeg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
...
case "black-md": case "owner": 
 ...
 client.sendMessage(m.chat, { video: { url: wife }, caption: `𝗛𝗲𝗿𝗲 𝗶𝘀 𝗺𝘆 𝗢𝘄𝗻𝗲𝗿 🚀 https://wa.me/message/4MX7ZQCAWRFBP1 🚀 𝗢𝗻𝗹𝘆 𝗗𝗺 𝘄𝗶𝘁𝗵 𝗮 𝗿𝗲𝗮𝘀𝗼𝗻🤏🏼`😎 }, {quoted: m}); 
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY BLACKMACHANT-BOT`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
` Hello👋 *${pushname}*,𝒀𝑶𝑼 𝑪𝑨𝑵 𝑫𝑬𝑷𝑳𝑶𝒀 𝐁𝐋𝐀𝐂𝐊-𝐌𝐃 𝐁𝐎𝐓 𝑼𝑺𝑰𝑵𝑮 𝑻𝑯𝑬 𝑮𝑰𝑻𝑯𝑼𝑩 𝑳𝑰𝑵𝑲 𝑩𝑬𝑳𝑶𝑾 𓅂\n\n🅵🅾🆁🅺 🅰🅽🅳 🅶🅸🆅🅴 🆄🆂 🅰 🆂🆃🅰🆁✨.\n\n ╭══──────              ─◇─             ──────══╮
